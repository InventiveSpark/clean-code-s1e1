...
const createNewTaskElement=function(taskString){
  ...
  label.className="list__label label label_text";

  //Each elements, needs appending
  checkBox.type="checkbox";
  checkBox.className="list__input input input_checkbox";
  editInput.type="text";
  ...
  deleteButtonImg.className="button__icon icon";
...
const editTask=function(){
  ...
  const label=listItem.querySelector(".label_text");
...
const bindTaskEvents=function(taskListItem,checkBoxEventHandler){
  ...
  const deleteButton=taskListItem.querySelector(".button.button_remove");
